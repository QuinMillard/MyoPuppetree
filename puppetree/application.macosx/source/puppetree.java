...
public class puppetree extends PApplet {
...
public void keyPressed() {
  isEngaged = true;
  quoteIndex = PApplet.parseInt(random(quotes.length));
  voiceIndex = PApplet.parseInt(random(TextToSpeech.voices.length));
...
static class TextToSpeech extends Object {
  ...
  public void settings() {  size(957, 375); }
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "puppetree" };
    if (passedArgs != null) {
